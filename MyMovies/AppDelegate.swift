...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        let myMoviesTableViewController = UINavigationController(rootViewController: MyMoviesTableViewController())
        myMoviesTableViewController.tabBarItem = UITabBarItem(tabBarSystemItem: .favorites, tag: 1)
        
        let tabBarController = UITabBarController()
        tabBarController.viewControllers = [searchTableViewController, myMoviesTableViewController]
